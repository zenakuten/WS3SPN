...
//copy paste from sniperfire, only change is to set teamnum
...
defaultproperties
{
     ...
     /*
     HitEmitterClass=Class'TeamColorLightningBolt'
     SecHitEmitterClass=Class'TeamColorChildLightningBolt'
     */
}
