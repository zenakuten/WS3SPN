class Message_RocketsGoBoom extends LocalMessage;

#exec AUDIO IMPORT FILE=Sounds\RocketsGoBoom.wav GROUP=Sounds
...
defaultproperties
{
     RocketManSound=Sound'WS3SPN.Sounds.RocketsGoBoom'
     YouAreRocketMan="ROCKETS GO BOOM!"
     PlayerIsRocketMan="IS A ROCKET BOOMER!"
     bIsUnique=True
     bFadeMessage=True
     DrawColor=(B=0,G=0)
     StackMode=SM_Down
